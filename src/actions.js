...
const INCREASE_BTN_COUNTER = "INCREASE_BTN_COUNTER";
const UPDATE_INPUT_LIST = "UPDATE_INPUT_LIST";
const DELETE_INPUT = "DELETE_INPUT";
const EDIT_INPUT = "EDIT_INPUT";
const STOP_EDITING = "STOP_EDITING";
const FIND_INPUTS_INDEX = "FIND_INPUTS_INDEX";
